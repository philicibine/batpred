...
class DaemonPathsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Derived at import time from the real SCRATCH_DIR, so patching the directory alone
        # leaves this pointing at the operator's live bot directory - which is where these
        # tests were writing until this line existed, and why a missing-directory test could
        # never fail. Any new PATH = <patched dir> / ... constant needs adding here too.
